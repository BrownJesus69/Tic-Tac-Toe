...
const winLine = document.getElementById('winLine'); // Should exist in HTML
const gameGrid = document.getElementById('gameGrid'); // Parent grid
...
function initializeGame() {
  // Ensure winLine is a direct child of .game-grid for correct positioning
  if (winLine && gameGrid && winLine.parentElement !== gameGrid) {
    gameGrid.appendChild(winLine);
  }
...
function showWinLine(pattern) {
  ...
  // Apply the correct orientation/position class
